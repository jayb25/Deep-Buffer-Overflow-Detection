...
class TrainCNN:
    ...
    def train(self, print_steps=1, display_data=100, save_steps=100):
        ...
        # with open(os.path.join(self.logdir, 'checkpoint'), 'rb') as f:
        #     model_name = next(f).split('"')[1]
        #     print(model_name)
        #     cnn_saver.restore(sess, os.path.join(self.logdir, model_name))
